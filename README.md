...
Current public deployment: Stellar testnet, generated by
[`deployments/testnet.toml`](./deployments/testnet.toml). It was deployed on
2026-07-03 from source commit `27ce5171145295d07878045d052de35e727d9d5c`
against the Blend v2 USDC pool.

| Component | Contract ID | Notes |
|---|---|---|
| USDC underlying SAC | [`CAQCFVLOBK5GIULPNZRGATJJMIZL5BSP7X5YJVMGCPTUEPFM4AVSRCJU`](https://stellar.expert/explorer/testnet/contract/CAQCFVLOBK5GIULPNZRGATJJMIZL5BSP7X5YJVMGCPTUEPFM4AVSRCJU) | `USDC:GATALTGTWIOT6BUDBCZM3Q4OQ4BO2COLOAZ7IYSKPLC2PMSOPPGF5V56` |
| SY wrapper | [`CCIBE7PR6YYZEIP5ISUCBGYT3ABF2UVQTJIWD6JAP5U7JX4QQCV6HXSN`](https://stellar.expert/explorer/testnet/contract/CCIBE7PR6YYZEIP5ISUCBGYT3ABF2UVQTJIWD6JAP5U7JX4QQCV6HXSN) | wraps the Blend v2 USDC position; on-chain Wasm hash `74a4151c01918082cc67dcab9e9d1d9a1b286694501729125af78c391168d5ab` |
| PT token | [`CBKJJDZ6HRRPAZQQJG3TZNAWBYXOM4FODD3K4ZTTLSQPUNRIVGVEX2NP`](https://stellar.expert/explorer/testnet/contract/CBKJJDZ6HRRPAZQQJG3TZNAWBYXOM4FODD3K4ZTTLSQPUNRIVGVEX2NP) | SEP-41 Principal Token; on-chain Wasm hash `d6c8d62e758a1c0a7dabb784c3131664013686a9edc528c1074cdf48c28e7e00` |
| YT token | [`CCNUVCKPGZHUH4AMGZQHUFQJQWC5RKNAU66FPJGGMF2ZVIESVABTSGDB`](https://stellar.expert/explorer/testnet/contract/CCNUVCKPGZHUH4AMGZQHUFQJQWC5RKNAU66FPJGGMF2ZVIESVABTSGDB) | SEP-41 Yield Token; on-chain Wasm hash `b7122ac24b489e804a9bdd6f0bdd0cc333aeb0c6d5fc20d48b1f4e7f180542ab` |
| Tokenizer | [`CDUQRPYG5OKTVXMG7JWYA7FZEBLQEWUHQGCKLAKXKHWWOYRJ4SIQOTXR`](https://stellar.expert/explorer/testnet/contract/CDUQRPYG5OKTVXMG7JWYA7FZEBLQEWUHQGCKLAKXKHWWOYRJ4SIQOTXR) | split, recombine, redeem, and yield-claim coordinator; on-chain Wasm hash `813617a898c75e2a8ee1e9edd3fa9774296d7b71802ef6a2d17dcf4b7c15d26f` |
| PT/SY AMM | [`CCAHVBXVU4VKU7WHYUJ3FH5NKOL7DPVAKA6FKPIQ6P56FUVUXLGTFWJ2`](https://stellar.expert/explorer/testnet/contract/CCAHVBXVU4VKU7WHYUJ3FH5NKOL7DPVAKA6FKPIQ6P56FUVUXLGTFWJ2) | experimental until no-mock auth verification; on-chain Wasm hash `2581b620789af8bfe424c659c1c42e45a56c973c883381ad5eff86b56ad264d9` |
| Blend v2 pool | [`CCEBVDYM32YNYCVNRXQKDFFPISJJCV557CDZEIRBEE4NCV4KHPQ44HGF`](https://stellar.expert/explorer/testnet/contract/CCEBVDYM32YNYCVNRXQKDFFPISJJCV557CDZEIRBEE4NCV4KHPQ44HGF) | external yield source |

The five custom contract hashes above were read back from testnet RPC and match
the manifest's `[onchain_hashes]` section.
